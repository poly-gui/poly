...
class NativeLayerServiceServer: NPRPCServer {
  ...
  private func registerCalls() {
    ...
    on("show_attached_dialog") { data, offset, msgID in
      var ptr = offset
      let titleSize = data.readSize(at: ptr)
      ptr += 4
      guard let title = data.read(at: ptr, withLength: titleSize) else {
      ...
      ptr += titleSize
      let messageSize = data.readSize(at: ptr)
      ptr += 4
      guard let message = data.read(at: ptr, withLength: messageSize) else {
        return nil
      }
      ptr += messageSize
      let windowTagSize = data.readSize(at: ptr)
      ...
      self.delegate.showAttachedDialog(title, message, windowTag)
      var data = Data(capacity: 6)
      data.append(int: NPRPCMessageType.response.rawValue)
      data.append(int: msgID)
      data.append(int: UInt8(0))
    ...
    on("show_dialog") { data, offset, msgID in
      var ptr = offset
      let titleSize = data.readSize(at: ptr)
      ptr += 4
      guard let title = data.read(at: ptr, withLength: titleSize) else {
      ...
      self.delegate.showDialog(title, message)
      var data = Data(capacity: 6)
      data.append(int: NPRPCMessageType.response.rawValue)
      data.append(int: msgID)
      data.append(int: UInt8(0))
...
class NativeLayerServiceClient: NPRPCClient {
  ...
  func showAttachedDialog(
    _ title: String, _ message: String, _ windowTag: String,
    completionHandler: @escaping (Result<Void, NPRPCError>) -> Void
  ) {
    let msgID = newMessageID()
    var data = Data(capacity: 9 + 20)
    ...
    data.append(int: msgID)
    data.append(int: UInt32(20))
    data.append(string: "show_attached_dialog")
    data.append(size: title.lengthOfBytes(using: .utf8))
    data.append(string: title)
    data.append(size: message.lengthOfBytes(using: .utf8))
    data.append(string: message)
    data.append(size: windowTag.lengthOfBytes(using: .utf8))
    data.append(string: windowTag)
  ...
  @available(macOS 10.15, iOS 13, *)
  func showAttachedDialog(_ title: String, _ message: String, _ windowTag: String) async -> Result<
    Void, NPRPCError
  > {
    let msgID = newMessageID()
    var data = Data(capacity: 9 + 20)
  ...
  func showDialog(
    ...
    let msgID = newMessageID()
    var data = Data(capacity: 9 + 11)
    data.append(int: NPRPCMessageType.request.rawValue)
    data.append(int: msgID)
    data.append(int: UInt32(11))
    data.append(string: "show_dialog")
    data.append(size: title.lengthOfBytes(using: .utf8))
    data.append(string: title)
    data.append(size: message.lengthOfBytes(using: .utf8))
    data.append(string: message)
  ...
  @available(macOS 10.15, iOS 13, *)
  func showDialog(_ title: String, _ message: String) async -> Result<Void, NPRPCError> {
    let msgID = newMessageID()
    var data = Data(capacity: 9 + 11)
    data.append(int: NPRPCMessageType.request.rawValue)
    data.append(int: msgID)
